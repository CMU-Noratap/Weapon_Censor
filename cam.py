...
if __name__ == '__main__':
    ...
    gradcam_image_path = "gradcam_image/"

    #model = torch.hub.load('ultralytics/yolov5', 'yolov5s', pretrained=True, autoshape=False)
    model = DetectMultiBackend('yolov5/runs/train/exp8/weights/best.pt')
    #print(model.model._modules.get("model"))
    #print(type(model.model))

    model.model = model.model._modules.get("model")[:8]
    ...
    #ckpt = torch.load('yolov5/runs/train/exp7/weights/best.pt')
    ...
    os.makedirs(f"{gradcam_image_path}{args.name}")
    cv2.imwrite(f'{gradcam_image_path}{args.name}/gradcam.jpg', cam_image)
